...
public class BoostAction {
    public MechRequestedMovement CalculateMovement(MechMovementStatus status, MechMovementConfigData config, BoostActionConfigData boostConfig, ref BoosterEngineStatus engineStatus) {
