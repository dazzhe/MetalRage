...
//public class BoostActionActivationRequestSystem : ComponentSystem {
...
//            var engine = this.EntityManager.GetComponentData<BoosterEngineStatus>(mechAction.Owner);
//            var isBoosting = locoState == MechLocoState.Acceling || locoState == MechLocoState.Boosting || locoState == MechLocoState.Braking;
//            if (isBoosting) {
//                if (engine.ElapsedTime > )
//            }
...
//public class BoostActionSystem : ComponentSystem {
//    protected override void OnUpdate() {
